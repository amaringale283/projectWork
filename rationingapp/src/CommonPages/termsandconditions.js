            ...
            <div>
                <br/>
                    ...
                    <div className="container col-md-12" style={{padding:"15px"}}>
                        <p style={{textAlign:"left"}}>BY ENTERING THIS SITE YOU ACKNOWLEDGE AND AGREE TO ALL TERMS AND CONDITIONS STATED HEREIN. IF
                        YOU DO NOT AGREE TO THESE TERMS, DO NOT USE THIS SITE.
                        <br/>
                        Rationing Portal is the copyright owner of everything on this site and no portion of this site, including
                        but not limited to the text, images, audio or video, may be used in any manner, or for any purpose, without
                        Rationing Portal express written permission, except as provided for herein. Without in any way waiving any of the
                        ...
                        purpose violates Rationing Portal legal rights.Except for copies printed for local use, and not for resale, no part of
                        this information may be reproduced, stored in a retrieval system, or transmitted without the prior written
                        permission of Rationing Portal.
                    </p>
                    </div>
                    <br/>
                    <br/>
